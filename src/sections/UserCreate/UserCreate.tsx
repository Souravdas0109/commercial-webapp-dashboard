        ...
        >
            ...
            >
              ...
              >
                <button
                  ...
                  // size="small"
                >
                  <span className={classes.addUserGroup}>Additional Data</span>
                </button>
              </Box>
            </Box>
          </Box>
              ...
              {groups ? (
                groups.length > 0 ? (
                  ...
                  <button
                    ...
                    ref={focusGroup}
                  >
                    <span className={classes.addUserGroup}>Add</span>
                  </button>
                )
              ) : (
                <button
          ...
          <Box className={classes.eachRow}>
            ...
            >
              ...
              >
                <Typography variant="subtitle2" className={classes.browseArea}>
                  {
                    <input
                      type="text"
