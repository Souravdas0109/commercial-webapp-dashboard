        ...
        <Grid container className={classes.margin} direction="column">
          <MuiPickersUtilsProvider utils={DateFnsUtils}>
            ...
            >
              ...
              <Typography variant="body1" color="primary" className={classes.tabOption}>
              Name
               </Typography>
                <TextValidator
                  //disabled={true}
                  disabled={false}
                  onChange={buildRangeResetName}
                  fullWidth
                  name="name"
                  value={name}
                  placeholder="Name"
          ...
          Buyer*
                ...
                <TextValidator
                  placeholder="Please enter Buyer name"
                  //disabled={isReadOnly}
                  disabled={false}
              ...
              Buyer Assistant*
                ...
                <TextField
                  id="buyerAssistant"
                  placeholder="Please enter Buyers Assistant name"
                  //disabled={isReadOnly}
                  disabled={false}
                  fullWidth
                  size="small"
              ...
              Supply Chain Specialist*
                ...
                <TextValidator
                  ...
                  name=""
                  placeholder="Please enter Supply chain specialist name"
                  //disabled={isReadOnly}
                  disabled={false}
                  validators={["required"]}
                  variant="outlined"
